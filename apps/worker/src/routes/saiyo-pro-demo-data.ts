...
export const SAIYO_PRO_BRAND_PRIMARY = '#00B8C8';
export const SAIYO_PRO_BRAND_SECONDARY = '#8DD72F';
export const SAIYO_PRO_BRAND_BLUE = '#18A9E6';
export const SAIYO_PRO_BRAND_ORANGE = '#FF9F1A';
export const SAIYO_PRO_BRAND_NAVY = '#061A33';
export const SAIYO_PRO_BRAND_MUTED = '#506070';
export const SAIYO_PRO_BRAND_SOFT_BG = '#EAFBF8';
